...
def evaluate():
    ...
    graphs_path = "/users/gy22186/mu3e/two_signal_files/test_graphs/testgraphs_dataset.pt"
    ...
    model.load_state_dict(torch.load("/users/gy22186/mu3e/two_signal_files/edge_classifier_pyg50nn.pt", map_location=device))
    model.eval()
...
def build_tracks(
    predictions, 
    data_list, 
    threshold_lo=0.9,  # Single threshold for filtering edges
    min_hits=4, 
