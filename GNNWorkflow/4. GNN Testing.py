...
model_path = "/users/gy22186/mu3e/trained_gnn_model_gpu.keras"  # Path to saved model
...
file_path = '/users/gy22186/mu3e/ten_signal_files/test_data.parquet'
...
def save_tracks(batch_tracks, output_dir="output"):
    ...
    # Save to CSV
    csv_path = "/users/gy22186/mu3e/ten_signal_files/predicted_tracks4.csv"
    df.to_csv(csv_path, index=False)

    """
    # Save to Parquet
    parquet_path = "/users/gy22186/mu3e/GNN_reconstructed_tracks/predicted_tracks4.parquet"
