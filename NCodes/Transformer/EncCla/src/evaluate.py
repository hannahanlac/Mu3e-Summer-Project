...
def evaluate(model, testloader, helperloader, truths_df, device, output_dir, wandb_logger):
...
def main(config_path):
    ...
    evaluate(model, data_loader, helper_loader, truths_df, device, output_dir, wandb_logger)
