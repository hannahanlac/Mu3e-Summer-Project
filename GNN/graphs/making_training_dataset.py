...
# %%
signal = uproot.open("/hdfs/user/ec6821/BristolFastML/Samples/GNN_Russell/delphes_output.root") # change path to origial dataset
bkg = uproot.open("/hdfs/user/ec6821/BristolFastML/Samples/GNN_Russell/delphes_nuGun.root") # change path to origial dataset
